-- =====================================================
-- eSIR 2.0 - COMPLETE DATABASE SETUP
...
-- =====================================================
-- 2. TABEL FASKES (Fasilitas Kesehatan)
-- =====================================================
...
-- =====================================================
-- 5. TABEL RUJUKAN (Data Rujukan Pasien)
-- =====================================================
...
-- =====================================================
-- 6. TABEL TEMPAT_TIDUR (Manajemen Tempat Tidur)
-- =====================================================
...
-- =====================================================
-- 7. TABEL TRACKING_DATA (Data Tracking Real-time)
-- =====================================================
...
-- =====================================================
-- 8. TABEL TRACKING_SESSIONS (Sesi Tracking)
-- =====================================================
...
-- =====================================================
-- 9. TABEL SEARCH_LOGS (Log Pencarian)
-- =====================================================
...
-- =====================================================
-- 10. TABEL NOTIFICATIONS (Sistem Notifikasi)
-- =====================================================
...
-- =====================================================
-- 11. TABEL DOKUMEN (Manajemen Dokumen)
-- =====================================================
...
-- =====================================================
-- 12. TABEL ACTIVITY_LOGS (Log Aktivitas)
-- =====================================================
...
-- =====================================================
-- 13. TABEL AMBULANCE_DRIVERS (Sopir Ambulans)
-- =====================================================
...
-- =====================================================
-- 14. TABEL PASSWORD_RESET_TOKENS (Reset Password)
-- =====================================================
...
-- =====================================================
-- 16. TABEL SYSTEM_CONFIG (Konfigurasi Sistem)
-- =====================================================
