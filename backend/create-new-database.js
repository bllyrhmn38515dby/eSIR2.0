...
async function setupDatabase() {
  try {
    ...
    await connection.promise().query('CREATE DATABASE IF NOT EXISTS esir_db_new');
    console.log('Database esir_db_new berhasil dibuat/ditemukan');

    // Gunakan database esir_db_new
    await connection.promise().query('USE esir_db_new');
    console.log('Menggunakan database esir_db_new');
