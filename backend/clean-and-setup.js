...
async function cleanAndSetup() {
  try {
    console.log('🧹 Membersihkan dan setup ulang database...');
    ...
    try {
      ...
      console.log('⚠️ Tabel rujukan tidak ada atau tidak bisa dihapus');
    }
    ...
    try {
      ...
      console.log('⚠️ Tabel users tidak ada atau tidak bisa dihapus');
    }
