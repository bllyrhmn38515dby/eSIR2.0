...
async function setupDatabase() {
  try {
    ...
    await connection.promise().query('CREATE DATABASE IF NOT EXISTS esirv2');
    console.log('Database esirv2 berhasil dibuat/ditemukan');

    // Gunakan database esirv2
    await connection.promise().query('USE esirv2');
    console.log('Menggunakan database esirv2');
