...
async function simpleUsers() {
  try {
    ...
    // Buat tabel users dengan struktur minimal tanpa foreign key
    ...
    console.log('✅ Login sekarang seharusnya berfungsi!');
