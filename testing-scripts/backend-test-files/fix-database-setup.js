...
async function fixDatabaseSetup() {
  try {
    console.log('🔧 Setup database yang sesuai dengan struktur yang ada...');
    ...
    // Buat tabel users yang sesuai dengan struktur yang ada
    await connection.execute(`
    ...
    // Buat tabel rujukan yang sesuai dengan struktur yang ada
    await connection.execute(`
